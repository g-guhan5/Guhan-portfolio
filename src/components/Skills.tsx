...
const Skills = () => {
  const skillCategories = [
    ...
    {
      category: 'React', skills: ['React Router', 'Hooks', 'Vite']
    },
    {
      category: 'Development Tools', skills: ['GitHub', 'npm','VS code', 'ChromeDev Tools']
    },
    {
      category: 'Design', skills: ['Canva', 'Photoshop']
    }
  ];
